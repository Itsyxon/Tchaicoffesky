...
export default function Home() {
  ...
  return (
    <main className="bg-white">
      ...
      <section>
        <div className="flex p-8 flex-col gap-5 md:p-24 md:gap-6 md:flex-row">
          <div className="flex items-center justify-center flex-col text-center gap-6">
            <div className="text-sm md:text-xl">Натуральные ингредиенты</div>
            <Image src='/coffee.svg' width={50} height={50} alt="coffee-icon" />
            <p className="hidden md:block">В наших напитках содержатся только натуральные ингредиенты. Мы тщательно подбираем поставщиков и контролируем качество.</p>
          </div>
          <div className="flex items-center justify-center flex-col text-center gap-6">
            <div className="text-sm md:text-xl">Квалифицированный персонал</div>
            <Image src='/staff.svg' width={50} height={50} alt="coffee-icon" />
            <p className="hidden md:block">Наши бариста обладают высоким профессионализмом и всегда готовы порадовать вас вкусным напитком, сделанным с любовью и умением.</p>
          </div>
          <div className="flex items-center justify-center flex-col text-center gap-6">
            <div className="text-sm md:text-xl">Обратная связь</div>
            <Image src='/message.svg' width={50} height={50} alt="coffee-icon" />
            <p className="hidden md:block">Мы ценим каждого нашего гостя и стремимся создать приятный опыт для каждого. Поэтому мы с радостью ответим на ваши вопросы в любом формате.</p>
          </div>
        </div>
      </section>
      <section>
        <div className="text-center p-4">
          <h2 className="text-xl my-3 md:text-4xl">Ближайшая кофейня</h2>
          <p className="md:text-2xl">Найдите нас на картах!</p>
